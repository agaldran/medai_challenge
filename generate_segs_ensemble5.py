...
parser.add_argument('--im_folder', type=str, default='data/MedAI_2021_Instrument_Segmentation_Test_Dataset', help='path to test data images') # or val4.csv
...
parser.add_argument('--load_checkpoint', type=str, default='polyps/fpnet_resnext101_W_SAMADAM_F', help='path to pre-trained checkpoints')
parser.add_argument('--save_path', type=str, default='results/polyps/fpnet_resnext101_W_SAMADAM_ENS12345/', help='path to save predictions')
